...
SET LEFT(SUBSTRING(Result, (CHARINDEX(‘caLastname’,Result, 0)+13, 20), LEN(SUBSTRING(Result, (CHARINDEX(‘caLastname’,Result, 0)+13, 20)-1) = lastName;
SET LEFT(SUBSTRING(Result, (CHARINDEX(‘caEmail’,Result, 0)+10, 20), LEN(SUBSTRING(Result, (CHARINDEX(‘caEmail’,Result, 0)+10, 20)-1) = email;
